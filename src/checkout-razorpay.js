  ...
  var e = {
              ...
              setTimeout(function () {
                ...
                P(f),
                  u && a
                    ...
                    : R({ event: t, properties: p, timestamp: l.zO() }),
                  a && D();
              })
            : S.push([t, n, a]);
        }
      ...
      84679: function (e, t, n) {
        ...
        var r = n.g !== n.g.parent,
          ...
          u = 5750873346,
          s = "baseline",
          l = "c51c9bad1e598459f350d35126fb2943f1aedb21",
          f =
    ...
    (function () {
      ...
      function F(e, t) {
        ...
        function f(t) {
          if (!i) {
            ...
            var r = a.splice(0, c);
            return (
              r.length && e(r, a), a.length ? (t ? f() : m()) : ((o = !1), s())
            );
          }
        }
        function m() {
      ...
      function G(e, t) {
        ...
        Object.keys(n)
          ...
          var t,
            n = null === (t = e.config) || void 0 === t ? void 0 : t[o];
          "function" == typeof n &&
            ((null != e && e.loaded()) || o === L.INITIALIZE
              ? n(a, r)
              : (function (e, t, n, r) {
                  e.pendingQ ||
                    (e.pendingQ = F(
      ...
      var Q = (function () {
          function e(t) {
            ...
            (this.flattenedContext = (0, Y.xH)(i)),
              ...
              W.Z.getItem(this.anonIdKey) || this.setAnonymousId(V()),
              (this.state = {
                app: n,
                ...
                value: function (e) {
                  W.Z.setItem(this.anonIdKey, e),
                    this.state &&
                      ...
                      $(this.state.subscriptions, K.ANON_ID_UPDATED, e));
                },
              },
              {
                key: "setUserId",
                value: function (e) {
                  W.Z.setItem(this.userIdKey, e),
                    this.state &&
                      ((this.state.userId = e),
                      $(this.state.subscriptions, K.USER_ID_UPDATED, e));
                },
              },
              {
                key: "on",
      ...
      function me(e) {
        try {
          var t = le.Z.api;
          return (
            se.isIframe && (t = (0, ue.resolveUrl)(le.Z.frameApi)),
            t.startsWith(e)
          );
        } catch (e) {
          return !1;
              ...
              we(
                ...
                (Te = !0),
                {
                  ...
                  identify: function (e) {
                    ...
                    })({ url: Re, key: Pe, payload: e }).catch(oe);
                  },
                  loaded: function () {
                    return !0;
                  },
      ...
      N.Z.subscribe("syncContext", function (e) {
        ...
        N.Z.subscribe("syncAnonymousId", function (e) {
          ...
          null !== (t = e.data) &&
            void 0 !== t &&
            t.anonymousId &&
            Ae.setAnonymousId(e.data.anonymousId);
        }),
                ...
                if (!n) {
                  var o = e[t],
                    i = (arguments.length <= 0 ? void 0 : arguments[0])
                      ? Ne(
                          Ne({}, arguments.length <= 0 ? void 0 : arguments[0]),
                          {},
                          { funnel: r }
                        )
                      : { funnel: r },
                  ...
                  if ("string" == typeof o) Ie.track(o, i, a);
                    ...
                    o.type && (c = "".concat(o.type, " ").concat(c)),
                      o.type !== j.ERROR && (je = { event: c, funnel: r }),
                      Ie.track(c, i, a);
                  }
                }
              };
      ...
      var Me = {
          ...
          getState: function () {
            return Ne(Ne({}, Ie.getState()), {}, { last: je });
          },
      ...
      (0, y.Z)(Le, "selectedBlock", {}),
        (0, y.Z)(Le, "selectedInstrumentForPayment", {
          method: {},
          instrument: {},
        }),
        (0, y.Z)(Le, "checkoutInvokedTime", Date.now()),
        (0, y.Z)(Le, "personalisationVersionId", ""),
        (0, y.Z)(Le, "submitScreenName", ""),
        (0, y.Z)(Le, "cardFlow", ""),
        (0, y.Z)(Le, "emiMode", ""),
        (0, y.Z)(Le, "flow", ""),
        (0, y.Z)(Le, "personalisationAPIType", ""),
        (0, y.Z)(Le, "contactPrefillSource", ""),
        (0, y.Z)(Le, "emailPrefillSource", "");
      var xe = Ce({ TRIGGERED: { name: "triggered", type: j.ERROR } });
      function Ze(e, t) {
        var n = Object.keys(e);
        if (Object.getOwnPropertySymbols) {
          var r = Object.getOwnPropertySymbols(e);
      ...
      var Fe = function (e, t) {
        ...
        try {
          var c,
            ...
            m = void 0 === f || f,
            d = !1;
          if (("razorpayjs" !== D.fQ.props.library && !he) || x.headlessChrome)
            return;
          (function (e) {
            try {
              var t = (0, T.HD)(e)
          ...
          var p = "string" == typeof s ? s : D.uG.JS_ERROR;
          (o !== k.F.S0 && o !== k.F.S1) || (0, D.rW)("session_errored", o);
          ...
          D.ZP.track(p, {
            ...
            xe.TRIGGERED({
              error: h,
              last:
                null === (c = Me.getState()) || void 0 === c ? void 0 : c.last,
            });
        } catch (e) {}
      };
      function Ke() {
      ...
      function We(e) {
        (e = (function (e) {
          ...
          (e = Ge(e, Ue)).callback_url && x.shouldRedirect && (e.redirect = !0),
          (this.get = function (t) {
      ...
      var Ve,
        ...
        qe = "com.phonepe.app",
        Qe =
          ("".concat(le.Z.cdn, "placeholder/bank_placeholder.png"), n(96120));
      var Xe = function (e) {
          var t =
              arguments.length > 1 && void 0 !== arguments[1]
                ? arguments[1]
          ...
          !n.key_id && r && (n.key_id = r),
            ...
            (t.tez || t.gpay) &&
              ((n["_[flow]"] = "intent"), n["_[app]"] || (n["_[app]"] = Je)),
      ...
      function rt() {
        ...
        return (!(arguments.length > 2 && void 0 !== arguments[2]) ||
          ...
          : "".concat(le.Z.api).concat(le.Z.version).concat(t);
      }
      function ot() {
        return rt(
          arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "",
          !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1],
          ["checkoutjs", "hosted"].includes((0, tt.AP)("library"))
        );
      }
      var it = (0, e.vl)();
      function at() {
      ...
      function st(e, t, n) {
        ...
        a && "".concat(c).length && i.push(a),
          (r.currency = i),
          se.optionsForPreferencesParams.forEach(function (e) {
            var n = t[e];
            n && (r[e] = n);
          }),
          (r["_[build]"] = se.BUILD_NUMBER),
          (r["_[checkout_id]"] = e),
      ...
      var lt,
        ...
        pt = Ce(ft, { funnel: Oe.HIGH_LEVEL }),
        ht = (Ce(mt, { funnel: Oe.RETRY }), Ce(dt, { funnel: Oe.P13N_ALGO })),
        vt = n(54041),
        yt = (function () {
          function t(e) {
            var n = this;
              ...
              },
              {
                ...
                value: function () {
                  ...
                  Object.assign(u, {
                    ...
                    async: !0,
                    onerror: function () {
                      return null == t ? void 0 : t(T.ip("Network error"));
                    },
                    onload: i,
      ...
      var _t = "gpay",
        ...
        bt =
          ...
          (0, y.Z)(lt, Je, Je),
          (0, y.Z)(lt, qe, qe),
          (0, y.Z)(lt, "microapps.gpay", "microapps.gpay"),
          (0, y.Z)(lt, "cred", "cred"),
          "x-client-ip");
      function Ot(e) {
        var t,
          r = this;
        if (!T.is(this, Ot)) return new Ot(e);
        Ke.call(this),
          (this.id = D.fQ.makeUid()),
          Me.setContext(ve.CHECKOUT_ID, this.id),
          D.ZP.setR(this);
        try {
          (t = (function (e) {
            (e && "object" === (0, P.Z)(e)) || T.kz("Invalid options");
            var t = new We(e);
            return (
              (function (e) {
                var t =
                  ...
                  n = !0;
                (e = e.get()),
                  Y.VX(Rt, function (r, o) {
                    if (!t.includes(o) && o in e) {
                      var i = r(e[o], e);
                      i && ((n = !1), T.kz("Invalid " + o + " (" + i + ")"));
                    }
                  });
              })(t, ["amount"]),
              (function (e) {
        ...
        try {
          D.fQ.props.library === se.RAZORPAYJS &&
            (D.ZP.track(se.CUSTOM_EVENTS.CUSTOM_CHECKOUT_INITIALISED, {
              data: { key: e.key },
            }),
            pt.CUSTOM_CHECKOUT_INITIALISED({ key: e.key }));
        } catch (e) {}
        Qe.ZP.updateInstance(this), this.postInit();
      }
      Ot.sendMessage = function (e) {
        throw new Error("override missing for event - ".concat(e.event));
      };
      var Et = (Ot.prototype = new Ke());
      function wt(e, t) {
        return (
          (n = {
      ...
      (Et.postInit = oe),
        (Et.onNew = function (e, t) {
          ...
          if ("ready" === e) {
              ...
              : wt(
                  (function (e) {
                    if (e) {
                      var t = {};
                      (t.key = (0, Qe.Rl)("key")),
                        (t.currency = (0, Qe.Rl)("currency")),
                        (t.display_currency = (0, Qe.Rl)("display_currency")),
                        (t.display_amount = (0, Qe.Rl)("display_amount")),
                        (t.key = (0, Qe.Rl)("key")),
                        se.optionsForPreferencesParams.forEach(function (e) {
                          var n = (0, Qe.Rl)(e);
                          n && (t[e] = n);
            ...
            try {
              D.zW.TrackMetric(se.CUSTOM_EVENTS.CUSTOM_CHECKOUT_PREFS, {
                key: this.get("key"),
              }),
                pt.CUSTOM_CHECKOUT_PREF({ key: this.get("key") });
            } catch (e) {}
          }
        }),
        (Et.emi_calculator = function (e, t) {
          return Ot.emi.calculator(this.get("amount") / 100, e, t);
        }),
        (Ot.emi = {
        ...
        (Ot.payment = {
          getMethods: function (e) {
            return wt({ key_id: Ot.defaults.key }, function (t) {
              e(t.methods || t);
            });
          },
          getPrefs: function (t, n) {
            var r = T.HT();
            return (
              D.ZP.track("prefs:start", { type: j.METRIC }),
              ht.P13N_CALL_INITIATED({ api: se.API.PREFERENCES }),
              Y.s$(t) &&
                (t["_[request_index]"] = D.ZP.updateRequestIndex(
                  se.API.PREFERENCES
                )),
              (0, ee.ZP)({
                ...
                callback: function (e, o) {
                  var i =
                    ...
                    typeof ((null == e ? void 0 : e.status_code) || e)
                      ...
                      : "";
                  if (
                    (D.ZP.track("prefs:end", {
                      type: j.METRIC,
                      data: { time: r(), status: i },
                    }),
                    200 !== (null == e ? void 0 : e.status_code) &&
                      ht.P13N_CALL_FAILED({ api: se.API.PREFERENCES }),
                    e.xhr && 0 === e.xhr.status)
                  )
                    return wt(t, n);
                  try {
                    window.clientIp = null == o ? void 0 : o[bt];
                  } catch (e) {}
                  n(e);
                },
              })
          ...
          getRewards: function (t, n) {
            var r = T.HT();
            return (
              D.ZP.track("rewards:start", { type: j.METRIC }),
              (0, ee.ZP)({
                url: (0, e.mq)(ot("checkout/rewards"), t),
                callback: function (e) {
                  D.ZP.track("rewards:end", {
                    type: j.METRIC,
                    data: { time: r() },
                  }),
                    n(e);
        ...
        (Et.fetchVirtualAccount = function (e) {
          var t = e.customer_id,
            n = e.order_id,
            r = e.notes;
      ...
      var St,
        Rt = {
          notes: function (e) {
            if (Y.s$(e) && T.Tk(Object.keys(e)) > 15)
          ...
          amount: function (e, t) {
            ...
            if (
              ...
              return "should be passed in integer"
                ...
                .concat(o)
                .concat(i, ", i.e. ")
                .concat((0, et.formatAmountWithSymbol)(o, n));
          },
          currency: function (e) {
            if (!et.supportedCurrencies.includes(e))
              return "The provided currency is not currently supported";
          },
          display_currency: function (e) {
            if (
              !(e in et.displayCurrencies) &&
              e !== Ot.defaults.display_currency
            )
      ...
      (Ot.configure = function (e) {
        ...
        Y.VX(Ge(e, Ue), function (e, t) {
          ...
          t.library &&
            ((D.fQ.props.library = t.library),
            (0, tt.F$)("library", t.library),
            Me.setContext(ve.LIBRARY, t.library)),
          t.referer &&
            ((D.fQ.props.referer = t.referer),
            Me.setContext(ve.REFERRER, t.referer));
      }),
        (Ot.defaults = Ue),
        (Ot.enableLite = Boolean(le.Z.merchant_key || le.Z.magic_shop_id)),
        (Ot.setConfig = function () {
          var e =
              arguments.length > 0 && void 0 !== arguments[0]
                ? arguments[0]
                : "",
        ...
        (Ue.name = ""),
        (Ue.partnership_logo = ""),
        (Ue.one_click_checkout = !1),
        (Ue.nativeotp = !0),
        (Ue.remember_customer = !1),
        (Ue.personalization = !1),
        (Ue.paused = !1),
        (Ue.fee_label = ""),
        (Ue.force_terminal_id = ""),
        (Ue.is_donation_checkout = !1),
        (Ue.webview_intent = !1),
        (Ue.keyless_header = ""),
        (Ue.min_amount_label = ""),
        (Ue.partial_payment = {
        ...
        (Ue.readonly = { contact: !1, email: !1, name: !1 }),
        (Ue.hidden = { contact: !1, email: !1 }),
        (Ue.modal = {
          confirm_close: !1,
          ondismiss: oe,
          onhidden: oe,
          ...
          animation:
            ...
            !(
              null !==
                (St = n.g.matchMedia("(prefers-reduced-motion: reduce)")) &&
              void 0 !== St &&
              St.matches
            ),
          backdropclose: !1,
        ...
        (Ue.external = { wallets: [], handler: oe }),
        (Ue.challan = { fields: [], disclaimers: [], expiry: {} }),
        (Ue.theme = {
          upi_only: !1,
          color: "",
      ...
      var jt = n(34376);
      (0, jt.fZ)({}), (0, jt.fZ)({ paymentMode: "online" });
      var Ct = function (e) {
        var t = at();
        switch (e) {
          case "mWebAndroid":
      ...
      var Mt = { "checkout.js": "checkout.js" };
      function Lt(e, t) {
        var n = Object.keys(e);
        if (Object.getOwnPropertySymbols) {
          var r = Object.getOwnPropertySymbols(e);
      ...
      var Ft,
        ...
        $t = {
          ...
          orientationchange: function () {
            $t.resize.call(this), $t.scroll.call(this);
          },
          resize: function () {
            var e = n.g.innerHeight || Gt.height;
            (Xt.container.style.position = e < 450 ? "absolute" : "fixed"),
      ...
      function qt() {
        var n = le.Z.frame || ot("checkout/public", !1),
          ...
          o = t.LF;
        return (
          o && ((r.magic_script = o ? 1 : 0), (r.unified_lite = 0)),
          (n = (0, e.mq)(n, r)),
          Ot.enableLite &&
            (n = (0, e.mq)(n, {
      ...
      function Qt(e) {
        try {
          Xt.backdrop.style.background = e;
        } catch (e) {}
      }
      function Xt() {
        (Ft = document.body),
      ...
      Xt.prototype = {
        ...
        openRzp: function (e) {
          var t = re.setStyles(this.el, { width: "100%", height: "100%" }),
            n = e.get("parent");
          n && (n = (0, ue.resolveElement)(n));
          var r = n || Xt.container;
          zt ||
            (zt = (function () {
              var e,
                t =
            ...
            e !== this.rzp &&
              (re.parent(t) !== r && re.append(r, t), (this.rzp = e)),
            this.rzp &&
              setTimeout(function () {
                Vt || D.zW.Track(D.pz.FRAME_NOT_LOADED);
              }, 1e4),
            (function (e) {
              var t = (0, Qe.Rl)("prefill.contact"),
                n = (0, Qe.Rl)("prefill.email");
              t && Me.setContext(ve.TRAITS_CONTACT, t),
                n && Me.setContext(ve.TRAITS_EMAIL, n),
                (0, Qe.NO)() && Me.setContext(ve.ORDER_ID, (0, Qe.NO)()),
                e && Me.setContext(ve.MODE, e);
              ...
              c &&
                (c === ge.RZP_APP
                  ? (i = ge.RZP_APP)
                  : c === be.PLUGIN && (a = be.PLUGIN),
                Me.setContext(ve.INTEGRATION_TYPE, c)),
                Me.setContext(ve.REFERRER_TYPE, i);
              try {
                Ct("androidSDK") ||
                  Ct("iosSDK") ||
                  Me.setContext(ve.INTEGRATION_PLATFORM, a);
              } catch (e) {}
              var u = (0, Qe.Rl)("_.integration_parent_version");
              u && Me.setContext(ve.INTEGRATION_PARENT_VERSION, u);
            })(this.rzp.getMode()),
            n
              ? (re.setStyle(t, "minHeight", "530px"), (this.embedded = !0))
              : (re.offsetWidth(re.setStyle(r, "display", "block")),
                Qt(e.get("theme.backdrop_color")),
                /^rzp_t/.test(e.get("key")) &&
                  Xt.ribbon &&
                  (Xt.ribbon.style.opacity = 1),
        ...
        makeMessage: function (e, n) {
          ...
          var a = {
            ...
            referer: D.fQ.props.referer || location.href,
        ...
        close: function () {
          Qt(""),
            Xt.ribbon && (Xt.ribbon.style.opacity = 0),
            (function (e) {
              e && e.forEach(re.detach);
              var t = Jt();
              t &&
                t.forEach(function (e) {
                  return re.appendTo(e, Kt);
                });
            })(this.$metas),
            (Ut.overflow = $t.overflow),
            this.unbind(),
            Wt && Yt(0, $t.oldY),
            D.fQ.flush();
        },
        bind: function () {
          ...
          if (!this.listeners) {
            ...
            var t = {};
            Wt &&
              ((t.orientationchange = $t.orientationchange),
              this.rzp.get("parent") || (t.resize = $t.resize)),
              Y.VX(t, function (t, n) {
        ...
        setMetaAndOverflow: function () {
          Kt &&
            ...
            ($t.overflow = Ut.overflow),
            (Ut.overflow = "hidden"),
            Wt &&
              (($t.oldY = n.g.pageYOffset),
              n.g.scrollTo(0, 0),
              $t.orientationchange.call(this)));
        },
        postMessage: function (e) {
          var t, n, r;
          e.id =
            (null === (t = this.rzp) || void 0 === t ? void 0 : t.id) || V();
          ...
          if (t) {
            ...
            if (
              ...
              (t = t.data),
                this["on" + n](t),
                ("dismiss" !== n && "fault" !== n) ||
                  D.ZP.track(n, { data: t, r: r, immediately: !0 });
            }
          }
        },
        ...
        onblur: function () {
          (this.isFocused = !1), $t.orientationchange.call(this);
        },
        onrender: function () {
          zt && (re.detach(zt), (zt = null)), this.rzp.emit("render");
        },
        onevent: function (e) {
        ...
        onsubmit: function (e) {
          var t;
          (t = { event: At, category: It }),
            (0, Qe.xA)() &&
              ((0, Qe.wZ)() && Ot.sendMessage({ event: "gaevent", data: t }),
              (0, Qe.E8)() && Ot.sendMessage({ event: "fbaevent", data: t })),
            D.fQ.flush();
          var n = this.rzp;
          "wallet" === e.method &&
        ...
        oncomplete: function (e) {
          ...
          n && this.ongaevent({ event: Dt, category: It }),
            r && this.onfbaevent({ event: Dt, category: It }),
            this.close();
          var o = this.rzp,
            i = o.get("handler");
          D.ZP.track("checkout_success", { r: o, data: e, immediately: !0 }),
            T.mf(i) &&
              setTimeout(function () {
                i.call(o, e);
              }, 200);
        ...
        onpaymenterror: function (e) {
          ...
          var t = this.rzp.get(),
            n = t.enable_ga_analytics,
            r = t.enable_fb_analytics;
          n && this.ongaevent({ event: Tt, category: It }),
            r && this.onfbaevent({ event: Tt, category: It });
          try {
            var o,
        ...
        onfailure: function (e) {
          ...
          r && this.ongaevent({ event: Tt, category: It }),
            o && this.onfbaevent({ event: Tt, category: It }),
            this.ondismiss(),
        ...
        onfault: function (e) {
          ...
          (this.rzp.get("redirect") || x.shouldRedirect) && r
            ? (0, kt.R2)({ url: r, params: { error: e }, method: "POST" })
            : n.g.alert("Oops! Something went wrong.\n" + t),
            this.afterClose();
        },
        afterClose: function () {
          Xt.container.style.display = "none";
        },
        onflush: function (e) {
          D.fQ.flush(e);
        },
      ...
      var nn,
        rn = "is_one_click_checkout_enabled_lite",
        on = "abandoned_cart",
        an = n(90345),
        cn = T.wH(Ot);
      function un(e) {
        return function t() {
          return nn ? e.call(this) : (setTimeout(t.bind(this), 99), this);
        };
      }
      !(function e() {
        (nn = document.body || document.getElementsByTagName("body")[0]) ||
          setTimeout(e, 99);
      })(),
        (function () {
          try {
            ...
            var t =
              null === (e = Ie.getPluginState(X.LUMBERJACK_PLUGIN)) ||
              void 0 === e
                ? void 0
                : e.config;
            null == t || t.pause();
        ...
        (0, tt.P_)(function (e, t) {
          try {
            if (t.pauseTracking && !e.pauseTracking) {
              var n,
                r =
                  null === (n = Ie.getPluginState(X.LUMBERJACK_PLUGIN)) ||
                  void 0 === n
                    ? void 0
                    : n.config;
              null == r || r.resume();
      ...
      var sn,
        ln =
          document.currentScript ||
          (sn = (0, ue.querySelectorAll)("script"))[sn.length - 1];
      function fn(e) {
        var t = re.parent(ln);
        (0, kt.VG)({ form: t, data: (0, kt.xH)(e) }),
          (t.onsubmit = oe),
          t.submit();
      }
      var mn, dn;
      function pn() {
        ...
        if (t && t.length > 0) {
          ...
          var n = Ot(e);
          e.parent ||
            (D.zW.TrackRender(D.pz.AUTOMATIC_CHECKOUT_OPEN, n),
            (function (e) {
              var t = re.parent(ln);
              re.append(
                t,
                Object.assign(re.create("input"), {
                  type: "submit",
      ...
      function hn() {
        if (!mn) {
          ...
          var n =
            ...
            ((a = re.create("span")).textContent = "Test Mode"),
            re.setStyles(a, {
      ...
      function _n() {
        if (!dn) {
          var e;
          (dn = new Xt()), (N.Z.iframeReference = dn.el), N.Z.setId(D.fQ.id);
          var t = dn.onmessage.bind(dn);
          null === (e = re.on("message", t)) || void 0 === e || e(n.g),
            re.append(mn, dn.el);
        }
        return dn;
      }
      (0, x.isBraveBrowser)().then(function (e) {
        ...
        (Ot.triggerShopifyCheckoutBtnClickEvent = function () {
          var e =
              arguments.length > 0 && void 0 !== arguments[0]
                ? arguments[0]
                : "unknown",
            t = arguments.length > 1 ? arguments[1] : void 0;
          D.zW.setMeta(an.U.BRANDED_BTN_PAGE_TYPE, e),
            D.zW.TrackBehav("1cc_shopify_checkout_click", { btnType: t });
        }),
        (cn.postInit = function () {
          var e = this;
          this.modal = { options: {} };
          var t = this.set;
      ...
      var gn = cn.onNew;
      (cn.onNew = function (e, t) {
        "payment.error" === e &&
          (0, D.fQ)(this, "event_paymenterror", location.href),
          T.mf(gn) && gn.call(this, e, t);
      }),
        (cn.open = un(function () {
          if (!this.metadata) {
            var e,
              ...
              r =
                ...
                void 0 === t
                  ? void 0
                  : t.getAttribute("lang");
            this.metadata = { isBrave: vn, isPrivate: yn, language: r };
          }
          ...
          return (
            ...
            o.openRzp(this),
            D.zW.setMeta(on, (0, Qe.p0)()),
            D.zW.setMeta(rn, (0, Qe.HU)() && !(0, Qe.Rl)("order_id")),
            ...
            "-new.js" === ln.src.slice(-7) &&
              (0, D.fQ)(this, "oldscript", location.href),
            this
          );
        })),
        (cn.resume = function (e) {
      ...
      var bn = un(function () {
          D.zW.setMeta(D.$J.IS_MOBILE, (0, x.isMobile)()),
            hn(),
            window.Intl ? (dn = _n()) : D.zW.Track(D.pz.INTL_MISSING),
            N.Z.subscribe(tn, function (e) {
              var t = (e.data || {}).url,
                n = Date.now(),
                r = window.onbeforeunload;
              window.onbeforeunload = null;
              try {
                (0, ue.redirectTo)({ method: "GET", content: "", url: t });
              } catch (e) {}
              setTimeout(function () {
                N.Z.sendMessage("".concat(tn, ":finished"), {
      ...
      n.g.addEventListener("rzp_error", function (e) {
        var t = e.detail;
        D.ZP.track("cfu_error", { data: { error: t }, immediately: !0 });
      });
      var En = [
      ...
      n.g.addEventListener("rzp_network_error", function (e) {
        ...
        (t &&
          ...
          D.ZP.track("network_error", { data: t, immediately: !0 });
      });
      var wn = "checkoutjs";
      (D.fQ.props.library = wn),
        (0, tt.F$)("library", wn),
        Me.setContext(ve.LIBRARY, wn),
        Me.setContext(ve.VERSION, se.COMMIT_HASH),
        (Ue.handler = function (e) {
          if (T.is(this, Ot)) {
            var t = this.get("callback_url");
            t && (0, kt.R2)({ url: t, params: e, method: "POST" });
          }
        }),
        (Ue.buttontext = "Pay Now"),
        (Ue.parent = null);
      (Rt.parent = function (e) {
        if (!(0, ue.resolveElement)(e))
