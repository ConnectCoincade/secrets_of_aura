...
const styles = {
  ...
  report: { fontWeight: "bold", fontSize: 19, textAlign: "center",marginTop:15,marginBottom:10 },
  page: { padding: 60 },
    ...
    <Document>
      <Page style={styles.page}>
        <View>
          ...
          <Text style={styles.address}>
            NEW LINK ROAD, ANDHERI WEST, MUMBAI CITY, MH, 400053, INDIA
          </Text>
        ...
        <View style={styles.table}>
          <View style={[styles.tableRow, styles.tableHeader]}>
            ...
            <View style={styles.tableStatusHeading}>
              <Text>Status</Text>
            </View>
          </View>
            ...
            <Form style={styles.form}>
              ...
              <div onClick={handleDownload}>
                <Button variant="primary" style={styles.button} disabled={disable}>
                  {disable ? (
                    <div style={{ color: "white" }}>Download Report</div>
                  ) : (
                    <PDFDownloadLink
                      document={<MyDocument />}
                      fileName="Report.pdf"
