        ...
        <Nav>
          <Row className="Row">
            <Col xs={12} md={4} className="footer-col" onClick={gotoHome}>
              <img src="https://amber-creative-capybara-584.mypinata.cloud/ipfs/QmYoTzFteHro1tJHRgLgfBiRhLu348hWX53j9JVpx3NBvR/logo-soa.png" alt="logo" className="footer-logo" />
            </Col>
